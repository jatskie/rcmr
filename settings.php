...
$ADMIN->add('rcmrfolder', new admin_externalpage('report_rcmr_course', get_string('reportcompletion', 'report_rcmr'),	"$CFG->wwwroot/report/rcmr/completion.php", 'report/stats:view',	empty($CFG->enablestats)));
